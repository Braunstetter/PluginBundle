 ...
 */
class Braunstetter_PluginBundle_Test_app_src_TestKernelDevDebugContainer extends Container
{
    ...
    public function __construct(array $buildParameters = [], $containerDir = __DIR__)
    {
        ...
        $this->fileMap = [
            ...
            'Braunstetter\\PluginBundle\\Services\\Plugins' => 'getPluginsService',
        ...
        $this->aliases = [
            'Braunstetter\\PluginBundle\\Test\\app\\src\\TestKernel' => 'kernel',
        ];
    ...
    private function getDynamicParameter(string $name)
    {
        switch ($name) {
            ...
            case 'debug.container.dump': $value = ($this->targetDir.''.'/Braunstetter_PluginBundle_Test_app_src_TestKernelDevDebugContainer.xml'); break;
    ...
    protected function getDefaultParameters(): array
    {
        return [
            ...
            'kernel.bundles' => [
                ...
                'PluginBundle' => 'Braunstetter\\PluginBundle\\PluginBundle',
                'PluginTestBundle' => 'Braunstetter\\PluginBundle\\Test\\plugin\\src\\PluginTestBundle',
            ],
            'kernel.bundles_metadata' => [
                ...
                'PluginTestBundle' => [
                    'path' => (\dirname(__DIR__, 4).'/tests/plugin/src'),
                    'namespace' => 'Braunstetter\\PluginBundle\\Test\\plugin\\src',
                ],
            ],
            'kernel.charset' => 'UTF-8',
            'kernel.container_class' => 'Braunstetter_PluginBundle_Test_app_src_TestKernelDevDebugContainer',
